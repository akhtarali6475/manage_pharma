...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post job_applications_url, params: { job_application: { email: @job_application.email, first_name: @job_application.first_name, job_application_form_id: @job_application.job_application_form_id, last_name: @job_application.last_name, phone_number: @job_application.phone_number } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { email: @job_application.email, first_name: @job_application.first_name, job_application_form_id: @job_application.job_application_form_id, last_name: @job_application.last_name, phone_number: @job_application.phone_number } }
