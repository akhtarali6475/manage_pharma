...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { avatars: @gallery.avatars, description: @gallery.description, place: @gallery.place, published: @gallery.published, title: @gallery.title } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { avatars: @gallery.avatars, description: @gallery.description, place: @gallery.place, published: @gallery.published, title: @gallery.title } }
